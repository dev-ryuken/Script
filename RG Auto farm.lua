...
elseif npc.Parent.Name == "GyakusatsuSpawn" then
    ...
    player.Character.HumanoidRootPart.CFrame = npc.HumanoidRootPart.CFrame * CFrame.Angles(0, math.rad(280), 0) + Vector3.new(0, myData.DistanceFromGya, 0)
else
